...
class ResourcesController extends Controller
{
     ...
     * 七牛文件上传回调地址
     */
    public function qiniuCallback(ResourceRequest $request,QiniuResource $qiniuResource){
        Log::info('>>>>>>>>>>>>>>>>>>>>七牛回调请求进入>>>>>>>>>>>>>>>>>>>>');
        ...
        //返回响应
        return $this->response->array(compact('id'))->header('Content-Type','application/json');
    }
